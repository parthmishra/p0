from interference import BuildInterferenceVisitor, ModifyLiveVisitor, free_vars
from class86 import *
from ir import *
...
from ir import *
from registerAlloc1 import RegisterAlloc, IntroSpillCode, AssignRegistersVisitor, \
